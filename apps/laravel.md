...
ORM migrations, login/session, one database-backed background job.
...
Current source: https://github.com/xCloudNobin/laravel-taskboard

Merged PR: https://github.com/xCloudNobin/laravel-taskboard/pull/1
